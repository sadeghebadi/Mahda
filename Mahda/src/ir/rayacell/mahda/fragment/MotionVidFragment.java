...
public class MotionVidFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.fragment_motion_video, container, false);
	...
	private void setUpInnerViewElements() {
		...
		et_ordertime = (EditText) v.findViewById(R.id.et_video_order_time);
		...
		btn_send_command.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Command command = new Command(
						...
						App.getContext()
								.getResources()
								.getString(R.string.command_video_motion_record),
						new DateTimeManager().getDateTime(dp_start, tp_start),
						Integer.parseInt(et_duration.getText().toString()),
						 0,
						0, (int) sp_quality.getSelectedItemId(),Integer.parseInt(et_ordertime.getText().toString()));
				Manager.videoMotoinRecord(command);
			}
		});
	}
}
