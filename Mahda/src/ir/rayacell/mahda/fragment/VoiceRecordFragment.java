...
import ir.smartlab.persindatepicker.*;
...
public class VoiceRecordFragment extends Fragment {
	...
	private void setUpInnerViewElements() {
		et_duration = (EditText) v.findViewById(R.id.et_voice_record_duration);
		tp_start = (TimePicker) v.findViewById(R.id.tp_voice_record);
		dp_start = (PersianDatePicker) v.findViewById(R.id.dp_voice_record);
		Util.set_timepicker_text_colour(tp_start, getActivity());

		btn_send_command = (Button) v.findViewById(R.id.btn_send_command_voice);
