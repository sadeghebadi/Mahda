...
public class ServerService extends IntentService {
	final int SocketServerPORT = 8085;
	int count = 0;
	Socket socket = null;
	...
	protected void onHandleIntent(Intent arg0) {
		...
		try {
			serverSocket = new ServerSocket(SocketServerPORT, 50,
					InetAddress.getByName(NetworkManager.getIpAddress()));
			...
			while (true) {
				...
				messageFromClient = EncryptDecrypt.decrypt(messageFromClient);
				// TODO
				...
				new AsyncTask<String, Void, Void>() {
					...
					protected Void doInBackground(String... arg0) {
						...
						Log.d("message from client", arg0[0]
								+ "##################################3");
						model = new Command(1, "1", arg0[0].toString(), "", 1,
								1, 1);
						return null;
					}
