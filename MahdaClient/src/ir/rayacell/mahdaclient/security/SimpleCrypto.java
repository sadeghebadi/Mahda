...
//	}
//
//	public Boolean encryptFile(File in, File out, String seed)
...
//	}
//
//	public Boolean decryptFile(File in, File out, String seed)
//			throws IOException, InvalidKeyException {
//		byte[] raw = null;
//		try {
//			raw = getRawKey(seed.getBytes());
...
//		copy(is, os);
////		in.delete();
////		if(out.renameTo(new File(out.getAbsolutePath().substring(0,out.getAbsolutePath().lastIndexOf("."))))){
////			out.delete();
////		}
//		
//		is.close();
